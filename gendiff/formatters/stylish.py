...
# print(format([{'key': 'a', 'type': 'unchanged', 'value': True}, {'key': 'b', 'type': 'unchanged', 'value': 'abcd'}, {'key': 'c', 'type': 'unchanged', 'value': 1}, {'key': 'd', 'type': 'unchanged', 'value': ['abc']}, {'key': 'e', 'type': 'unchanged', 'value': None}]))